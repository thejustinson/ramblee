...
function LoginInner() {
  ...
  return (
    <div className="min-h-screen bg-brand-black flex flex-col items-center justify-center p-6 text-brand-white">
      <Link
        href="/"
        className="absolute top-6 left-6 md:top-8 md:left-8 font-display font-bold text-xl tracking-wider uppercase text-brand-muted hover:text-brand-white transition-colors"
      >
        Ramblee
      </Link>
      ...
      >
        ...
        <p className="text-brand-muted mb-10 text-center leading-relaxed">
          Sign in to manage your rooms, track your history, and build your stats.
        </p>
...
export default function LoginPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-brand-black flex items-center justify-center text-brand-muted">Loading…</div>
      }
    >
      <LoginInner />
    </Suspense>
